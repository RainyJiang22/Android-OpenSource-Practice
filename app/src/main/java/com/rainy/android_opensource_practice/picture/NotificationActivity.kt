...
import com.rainy.android_opensource_practice.databinding.ActivityNotificationBinding
 ...
 * @date 2022/11/17
 */
class NotificationActivity:BaseActivity<BaseViewModel,ActivityNotificationBinding>() {
