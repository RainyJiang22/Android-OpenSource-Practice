...
object EasyDataStore {
    ...
    val BaseApp.DataStore: DataStore<Preferences> by preferencesDataStore(name = "Setting")

    val dataStore = BaseApp.instance.DataStore
     ...
     * 取出Long数据
     */
    private fun getLongData(key: String, default: Long = 0L): Long = runBlocking {
        return@runBlocking dataStore.data.map {
