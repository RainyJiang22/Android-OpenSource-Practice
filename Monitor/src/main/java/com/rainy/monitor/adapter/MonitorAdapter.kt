...
import com.rainy.monitor.databinding.ItemMonitorBinding
...
internal class MonitorAdapter : RecyclerView.Adapter<MonitorAdapter.MonitorViewHolder>() {
    ...
    class MonitorViewHolder(itemMonitorBinding: ItemMonitorBinding) :
        RecyclerView.ViewHolder(itemMonitorBinding.root) {

        val view: View = itemView
        val tvId: TextView = itemMonitorBinding.tvId
        val tvCode: TextView = itemMonitorBinding.tvCode
        val tvPath: TextView = itemMonitorBinding.tvPath
        val tvHost: TextView = itemMonitorBinding.tvHost
        val ivSsl: ImageView = itemMonitorBinding.ivSsl
        val tvRequestDate: TextView = itemMonitorBinding.tvRequestDate
        val tvDuration: TextView = itemMonitorBinding.tvDuration
        val tvSize: TextView = itemMonitorBinding.tvSize
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MonitorViewHolder {
        return MonitorViewHolder(ItemMonitorBinding.inflate(LayoutInflater.from(viewGroup.context)))
    }
